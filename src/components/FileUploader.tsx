                    ...
                    <div style={{padding: '20px'}}>
                                    ...
                                    <div style={{maxHeight: '200px', overflowY: 'auto'}}>
                                        {pendingChunks.map((chunk, index) => (
                                            <div key={index} style={{
                                                ...
                                                <span style={{
                                                    fontSize: '12px',
                                                    color: (chunk as any).downloaded ? '#28a745' : '#333',
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    gap: '5px'
                                                }}>
                        ...
                        {isProcessing && (
                            <Alert severity="info"
                                ...
                                <div style={{display: "flex", gap: "1vh", alignItems: "anchor-center"}}>
                                    <Loop className="rotating"/> Processing... Please wait and don't close the browser.
                                </div>
                            </Alert>
                        )}
                        ...
                        {currentMetadata && (
                            <div style={{
                                ...
                                <p><strong>Size:</strong> {(currentMetadata.originalSize / 1024 / 1024).toFixed(2)} MB
                                </p>
